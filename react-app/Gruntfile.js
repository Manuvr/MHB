module.exports = function (grunt) {
  ...
  var OUTPUT_PATH = './dist/javascripts/react-app.js';
  ...
  grunt.initConfig({
    ...
    exorcise: {
      bundle: {
        files: {
          './dist/javascripts/react-app.map': [OUTPUT_PATH]
        }
      }
    },
    uglify: {
      release: {
        options: {
          ...
          sourceMapIn: 'dist/javascripts/react-app.map'
        },
        files: {
          'dist/javascripts/react-app.min.js': ['dist/javascripts/react-app.js']
        }
      }
    }
  });
