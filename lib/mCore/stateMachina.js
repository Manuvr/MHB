 ...
 // |_|  |_/_/ \_\___/ |_| |___|_|_\
      ...
      case 'SELF_DESCRIBE':
        ...
        switch(msgObj.args.length){
          case 0:
            ...
            var tmpArr = [ver.mtu, ver.defFlags, ver.pVersion, ver.identity, ver.fVersion]
            if('hVersion' in ver) {
  ...
  this.clientIn = function(msgObj){
    ...
    if (test.every(function(x) { return x in msgObj })) {
      masterState.handle("msg_" + msgObj.messageDef !== undefined ? msgObj.messageDef : "WUT", msgObj);
    } else {
