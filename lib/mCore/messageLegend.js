...
var flag = require('./messageFlags.js');
...
var messageLegend = {
  ...
  0: {
    ...
    */
    flag: 0,
    //  requied arg0  arg1  arg2
    // [5,      14,   14,   7]
    argForm: [],
    //semantic: { "label" : ["herp", "derp"] },
    name: 'UNDEFINED'
  },
  ...
  7: {
    ...
    */
    flag: 0x0004,
    // argForms: {
    //   '4': [8, 8, 14, 14, 14],            // Will be "length 11"
    //   '2': [8, 8, 14, 14, 14, 14],        // Will be "length 12"
    //   '3': [8, 8, 14, 14, 14, 14, 14],     // Will be "length 13"
    argForm:  [5, 8, 8, 14, 14, 14, 14, 14, 14]  // Will be "length 14"
    },
    name: 'SELF_DESCRIBE'
  },
