...
var executeCommand = function (jsonBuff) {
    if (commands[jsonBuff.messageId].def === "IMU_MAP_STATE") {
        var holdBuffHere = JSON.stringify(jsonBuff);
        //gloveModel.powerMode = argObj.
        ...
        var bases = ["PP_2", "IP_2","DP_2","PP_3","IP_3","DP_3","PP_4","IP_4",
            "DP_4","PP_5","IP_5","DP_5","PP_1","IP_1","DP_1",
            "METACARPALS","CARPALS"
        ];
        var toFill = ["mx", "my", "mz"];
        var pull = ["x", "y", "z"];
        ...
        for (var b = 0; b < bases.length; b++) {
            for (f = 0; f < toFill.length; f++) {
                if (argObj['204'] != undefined && argObj['204'][b] != undefined) {
                    //gm[bases[b]][toFill[f]] = argObj['204'][b][pull[f]];
                }
                count++;
            }
        }
...
var commands = {
    1: { flag: 0, argForms: {}, def: 'SYS_BOOT_COMPLETED' },
    ...
    58401:
    { flag: 0,
        argForms: { '204': [ 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18, 18 ] },
        def: 'IMU_MAP_STATE' },
...
var argRef = {
    0     :   { len: 0},
    1     :   { len: 1, val: function(buff){return buff.readInt8()}},
    2     :   { len: 2, val: function(buff){return buff.readInt16LE()}},
    3     :   { len: 4, val: function(buff){return buff.readInt32LE()}},
    ...
    6     :   { len: 1, val: function(buff){return buff.readUInt8()}} ,
    7     :   { len: 2, val: function(buff){return buff.readUInt16LE()}},
    8     :   { len: 4, val: function(buff){return buff.readUInt32LE()}},
    9     :   { len: 8, val: function(buff){return 0}}, // unsigned 64bit int
    10    :   { len: 16, val: function(buff){return 0}}, // unsigned 128bit int
    11    :   { len: 1, val: function(buff){return buff.readInt8()}}, // boolean
    12    :   { len: 4, val: function(buff){return buff.readFloatLE()}},
    13    :   { len: 8, val: function(buff){return buff.readDoubleLE()}},
    14    :   { len: 0, exec: function(buff){return buff.toString('ascii')}}   ,
    15    :   { len: 0, exec: function(buff){return buff}} ,   // binary blob
    16    :   { len: 0, exec: function(buff){return 0}} ,   // AUDIO
    17    :   { len: 0, exec: function(buff){return 0}},    // IMAGE
    18    :   { len: 12, exec: function(buff){return {x: buff.readFloatLE(0), y: buff.readFloatLE(4), z: buff.readFloatLE(8)}}},    // Vector3 formats
    19    :   { len: 6, exec: function(buff){return {x: buff.readInt16LE(0), y: buff.readInt16LE(2), z: buff.readInt16LE(4)}}},
    20    :   { len: 6, exec: function(buff){return {x: buff.readUInt16LE(0), y: buff.readUInt16LE(2), z: buff.readUInt16LE(4)}}},
    21    :   { len: 0, exec: function(buff){return buff}}, // MAP
    0xFE  :   null  // REPLY?
};
