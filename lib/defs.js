...
var executeCommand = function (jsonBuff) {
    if (commands[jsonBuff.messageId].callback != undefined) {
        commands[jsonBuff.messageId].callback(jsonBuff);
    }
    else {
...
var commands = {
    ...
    { flag: 0,
        ...
        def: 'IMU_MAP_STATE', modelMap: 'IMU_set', callback: execute_IMU_MAP_STATE },
