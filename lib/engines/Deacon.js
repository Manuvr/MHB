...
function mEngine(parent) {
  ...
  that.beaconConfig = {
    ...
    UID:                 '000000000000000000000000abcdabcd',
  ...
  this.setName = function(data) {
    ...
    that.esBeacon.advertiseUid(that.beaconConfig.UID.slice(0,20), that.beaconConfig.UID.slice(20,32), that.beaconConfig.eddyOpts);
      ...
      inputs: {
        'scanResult': {
          func: function(me, data) {
            ...
            me.send('deviceSighted', data.args[0]);
            return true
          },
          hidden: true
        },
  ...
  that.esBeacon.advertiseUid(that.beaconConfig.UID.substr(0,20), that.beaconConfig.UID.substr(20,32), that.beaconConfig.eddyOpts);
  that.esBeacon.advertiseUrl(that.beaconConfig.url, that.beaconConfig.eddyOpts);
