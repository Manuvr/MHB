      ...
      inputs: {
        'setName': {
          ...
          func: function(me, data) {
            me.beaconConfig.eddyOpts.name = data.toString();
            me.esBeacon.advertiseUid(me.beaconConfig.UID.slice(0,10), me.beaconConfig.UID.slice(10,16), me.beaconConfig.eddyOpts);
            me.esBeacon.advertiseUrl(me.beaconConfig.url, me.beaconConfig.eddyOpts);
          },
          hidden: false
        },
        'setURL': {
          ...
          func: function(me, data) {
            me.beaconConfig.url = data.toString();
            me.esBeacon.advertiseUid(me.beaconConfig.UID.slice(0,10), me.beaconConfig.UID.slice(10,16), me.beaconConfig.eddyOpts);
            me.esBeacon.advertiseUrl(me.beaconConfig.url, me.beaconConfig.eddyOpts);
          },
          hidden: false
        ...
        'setKey': {
          ...
          args: [ { label: 'URL', type: 'string' }],
          func: function(me, data) {
            me.beaconConfig.cryptKey = data.toString();
          },
          hidden: false
        },
        'setIV': {
          ...
          func: function(me, data) {
            ...
            me.beaconConfig.cryptIV = data.toString();
          },
          hidden: false
        },
        'setRotationInterval': {
        ...
        'setTxPower': {
          ...
          func: function(me, data) {
            me.esBeacon.stop();
            me.beaconConfig.eddyOpts.txPowerLevel = parseInt(data);
            me.esBeacon.advertiseUid(me.beaconConfig.UID.slice(0,10), me.beaconConfig.UID.slice(10,16), me.beaconConfig.eddyOpts);
            me.esBeacon.advertiseUrl(me.beaconConfig.url, me.beaconConfig.eddyOpts);
          },
          hidden: false
    ...
    taps: {
      ...
      "mEngine": {
        "CHANGE_NAME" : function(me, msg, adjunctID){
          me.options.name = msg.data.args[0].toString();
        ...
        "CHANGE_URL" : function(me, msg, adjunctID){
          me.url = msg.data.args[0].toString();
          me.esBeacon.advertiseUid(me.namespace, me.nonce, me.options);
          me.esBeacon.advertiseUrl(me.url, me.options);
          return true;
        },
        "CHANGE_TX_POWER" : function(me, msg, adjunctID){
          me.options.txPowerLevel = parseInt(msg.data.args[0]);
          me.esBeacon.advertiseUid(me.namespace, me.nonce, me.options);
          me.esBeacon.advertiseUrl(me.url, me.options);
          return true
        }
