  ...
  */
  ...
  this.interface_spec.taps.names["Registry"] = {
    "newThingId": function(me, msg, adjunctID){
      console.log("hopefully sending new Thing ID...")
      me.mH.sendToAdjunct(genEngine, {target: ["bless", "metaSchema"], data: msg.data})
      return true;
    },
    "claimed": function(me, msg, adjunctID){
      console.log("hopefully sending claimed...")
      me.mH.sendToAdjunct(genEngine, {target: ["takeOwnership", "metaSchema"], data: msg.data})
      return true;
    }
  }
