...
function mHub(cli_config) {
  ...
  */
  ...
  this.interface_spec.taps.names["Registry"] = {
    "newThingId": function(me, msg, adjunctID){
      me.sendToAdjunct(genEngine, {target: ["bless", "metaSchema"], data: msg.data})
      return true;
    },
    "claimed": function(me, msg, adjunctID){
      me.sendToAdjunct(genEngine, {target: ["takeOwnership", "metaSchema"], data: msg.data})
      return true;
    }
  }

  this.interface_spec.taps.names["BluetoothSerialFactory"] = {
    "scanResult": function(me, msg, adjunctID){
      me.emit('input', {target: ["scanResult", "metaSchema", genEngine], data: msg.data})
      return true;
    }
  }

  this.interface_spec.taps.names["TCPSocketFactory"] = {
    "connect": function(me, msg, adjunctID){
      me.emit('input', {target: ["assignEngine"], data: ['NewSession0', 'Deacon.js']});
      return true;
    }
  }
