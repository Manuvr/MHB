...
var stateMachine = require('./mCore/stateMachine.js');
...
function mCore(transport) {
  ...
  // this will never happen... delete as soon as the logic is in stateMachine.js

  // if outofsync, send a sync packet to the Transport and me.send 'syncd': false
  // if in sync, clear the sync timer count, send a KA message, build it, emit 'syncd': true and log something
  //
