...
function mCore() {
  ...
  */
  this.buildSelfDescription = function(desc_from_stack) {
      ...
      inputs: {
        'syncd': {
          ...
          func: function(me, data) {
            me.fromEngine('log', ['AM I SYNCD? ' + data, 5]);
        ...
        'SELF_DESCRIBE': {      
          ...
          func: function(me, data) {
            me.buildAction.bind(me)(me.buildSelfDescription(data));
          },
          hidden: true
        },
        'connected': {
          ...
          args: [ { label: 'Syncd', type: 'boolean' } ],
          func: function(me, data) {
            me.fromEngine('log', ['AM I CONNECTED? ' + data, 5]);
            if (data) {
              me.sendSync()
            }
         },
