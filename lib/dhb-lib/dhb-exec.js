function Exec(models, argParser) {
  ...
  this.IMU_MAP_STATE = function (jsonBuff) {
	...
	this.messageRef =  {
		...
		1546: 	{ callback: this.IMU_TAP, reply: true , refresh: true , argParse: false, type: 'IMU_TAP'},
		1547: 	{ callback: this.IMU_DOUBLE_TAP, reply: true , refresh: true , argParse: false, type: 'IMU_DOUBLE_TAP'},
