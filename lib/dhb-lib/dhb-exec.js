function Exec(models, argParser) {
			...
			for (var b = 0; b < Object.keys(gm).length; b++) {
				...
				for(var r = 0; r < 3; r++){
					for(var t = 0; t < 3; t++){
						...
						gm[imuBase][imuBaseReading] = argObj[r + (b * 4)][argObjSub[t]];
						tick++;
					}
				}
	...
	this.messageRef =  {
		...
		5: {     },
		16: {    },
		17: { callback: this.LEGEND_MESSAGES, reply: true, refresh: true, argParse: false, type: "LEGEND_MESSAGES"},
		18: {    },
		19: {    },
		20: {    },
		256: {   },
		...
		57349: { },
		57360: { },
		58401: { callback: this.IMU_MAP_STATE , reply: false , refresh: false, argParse: true, type: "GLOVE_MODEL" },
		65533: { },
		65534: { },
		65535: { }
	}
