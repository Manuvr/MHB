...
*/
	argRef: {
		...
		18    :   { len: 12,val: function(buff){return [ buff.readFloatLE(0), buff.readFloatLE(4), buff.readFloatLE(8) ] }},    // Vector3 formats
		19    :   { len: 6, val: function(buff){return [ buff.readInt16LE(0), buff.readInt16LE(2), buff.readInt16LE(4) ] }},
		20    :   { len: 6, val: function(buff){return [ buff.readUInt16LE(0), buff.readUInt16LE(2), buff.readUInt16LE(4) ] }},
		21    :   { len: 0, val: function(buff){return buff}}, // MAP
		22    :   { len: 16, val: function(buff){return [ buff.readFloatLE(0), buff.readFloatLE(4), buff.readFloatLE(8), buff.readFloatLE(12) ] }}, // Vector4 (quat)
		0xFE  :   null  // REPLY?
	},
	outCommand: {}
}
